  ...
  describe '.for' do
    context 'when receives a problem (csp) and dependency' do
      it ' initialize using problem' do
        ...
        filter = described_class.for(problem: problem, dependency: dependency)

        expect(filter).to have_attributes(class: described_class, problem: problem)
      end
    end
    ...
    context 'when no dependency is received' do
      it 'initialize using problem' do
        ...
        filter = described_class.for(problem: problem)
  ...
  describe '.for' do
    ...
    context 'when no problem is received' do
      it 'initialize using dependency' do
        ...
        filter = described_class.for(dependency: dependency)
